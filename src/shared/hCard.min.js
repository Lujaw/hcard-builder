  ...
  })(
    {
        ...
        function (e, t, n) {
          ...
          (t.exports = r),
            ...
            (r.prototype.emit = function (e) {
              let t; let n; let r; let o; let l; let u;
              if (
                (this._events || (this._events = {}),
                  "error" === e &&
                  (!this._events.error ||
      ...
      4: [
        function (e, t, n) {
          (function (e) {
            "use strict";
            const n = function (t, n, r, i, o, s, a, l) {
      ...
      6: [
        function (e, t, n) {
          ...
          const o = e("../dispatcher/Dispatcher.js");
          const s = i(o);
          const a = e("../constants/Constants.js");
          const l = r(a);
          const u = {
        ...
        { "../constants/Constants.js": 13, "../dispatcher/Dispatcher.js": 14 }
      ],
      7: [
        function (e, t, n) {
          (function (t) {
            ...
            const l =
              "undefined" != typeof window ?
                ...
                "undefined" != typeof t ?
                  ...
                  null;
            const u = r(l);
            const c = e("./stores/HcardStore.js");
            const f = r(c);
            const d = e("./components/HcardForm.js");
            const p = r(d);
            const h = e("./components/HcardPreview.js");
            const v = r(h);
            const _ = (function (e) {
              function t(e) {
                i(this, t);
                ...
                return (
                  ...
                  (n.state = { fields: f.default.fields }),
                  (n.stateUpdated = function () {
                    n.setState({ fields: f.default.fields });
                  }),
                  (n.onBlur = function (e) {
                    if (f.default.fields.id.value === "") {
                      console.log("Update action will be triggered after 'Create Hcard' button is pressed with full valid data");
                    }
                    else {
                      fetch("/update", {
                        method: "POST",
                        body:
                          e +
                          "=" +
                          encodeURIComponent(f.default.fields[e].value) +
                          "&id=" + encodeURIComponent(f.default.fields.id.value),
                        headers: {
      ...
      8: [
        function (e, t, n) {
          (function (t) {
            ...
            const l =
              "undefined" != typeof window ?
                ...
                "undefined" != typeof t ?
                  ...
                  null;
            const u = r(l);
            const c = e("./HcardForm/FormSection.js");
            const f = r(c);
            const d = e("../actions/Actions.js");
            const p = r(d);
            const h = (function (e) {
              function t(e, n) {
                i(this, t);
                      ...
                      return u.default.createElement(
                        ...
                        u.default.createElement(
                          ...
                          u.default.createElement("input", {
                            className: "form-control card-id hcardForm__input",
                            type: "hidden",
                            defaultValue: this.props.fields.id.value,
                            name: "id",
                          }),
                          u.default.createElement(
                            "div",
                            ...
                            u.default.createElement(
                              ...
                              u.default.createElement(
                                ...
                                u.default.createElement(
                                  ...
                                  (this.props.fields.id.value && "Update Card" || "Create hCard")
                                )
                              )
                            )
                          )
            ...
            (n.default = h),
              (h.propTypes = { fields: u.default.PropTypes.object.isRequired });
          }.call(
            this,
            "undefined" != typeof global ?
              global :
        ...
        { "../actions/Actions.js": 6, "./HcardForm/FormSection.js": 10 }
      ],
      9: [
        function (e, t, n) {
          (function (t) {
                ...
                a(t, [
                  {
                    key: "render",
                    value: function () {
                      const e = this.props.fieldKeys[0];
                      const t = this.props.fields[e].label;
                      const n = this.props.fields[e].value;
                      const r = this.props.fieldKeys[1];
                      const i = this.props.fields[r].label;
                      const o = this.props.fields[r].value;
                      return u.default.createElement(
                        "div",
                        { className: "row" },
                        u.default.createElement(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return u.default.createElement(
                        ...
                        this.rows(this.props.fieldKeys)
                      );
                    }
                  }
                ]),
      ...
      12: [
        function (e, t, n) {
          (function (e) {
                ...
                s(t, [
                  {
                    ...
                    value: function () {
                      return (
                        this.props.fields.givenName.value +
                        " " +
                        this.props.fields.surname.value
                      );
                    }
                  },
                  {
                    ...
                    value: function () {
                      return (
                        this.props.fields.houseNumber.value +
                        " " +
                        this.props.fields.street.value
                      );
                    }
                  },
                  {
                    ...
                    value: function () {
                      return (
                        this.props.fields.suburb.value +
                        ", " +
                        ...
                        l.default.createElement(
                          ...
                          l.default.createElement(
                            ...
                            l.default.createElement("img", {
                              ...
                              src: this.props.fields.avatar.value || "/static/img/avatar.png"
                            }),
                            l.default.createElement(
                              "div",
                              ...
                              l.default.createElement(
                                ...
                                l.default.createElement(
                                  ...
                                  this.props.fields.postcode.value
                                ),
                                l.default.createElement(
                                  "span",
                                  {
            ...
            (n.default = u),
              (u.propTypes = { fields: l.default.PropTypes.object.isRequired });
          }.call(
            this,
            "undefined" != typeof global ?
              global :
      ...
      15: [
        function (e, t, n) {
          ...
          const u = e("./Store");
          const c = i(u);
          const f = e("../dispatcher/Dispatcher");
          const d = i(f);
          const p = e("../constants/Constants");
          const h = r(p);
          const v = (function (e) {
            function t() {
              o(this, t);
              ...
              return (
                (e.fields = {
                  givenName: { label: "Given Name", value: "" },
                  surname: { label: "Surname", value: "" },
                  email: { label: "Email", value: "" },
                  phone: { label: "Phone", value: "" },
                  houseNumber: { label: "House Name or #", value: "" },
            ...
            d.default.register(function (e) {
              console.log("dispatcher", e, h.BLUR_FIELD),
                e.actions === h.UPDATE_FIELD ?
                  ((_.fields[e.field_id].value = e.value), _.emitChange()) :
